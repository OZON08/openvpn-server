...
#
# Wire it into openvpn server.conf with (script-security 2 is already set by
# docker-entrypoint.sh via the CLI):
#   client-disconnect /opt/app/bin/client-disconnect.sh
#
